<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <!-- Nav Item - étudiant -->
        <h5 class="btn btn-danger"><strong><em> table étudiant</em></strong></h5>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('etudiants.index') }}">
            ...
            <!-- Nav Item - enseignant -->
    <h5 class="btn btn-success"><strong><em> table enseignant</em></strong></h5>
    <li class="nav-item">
    ...
    <h5 class="btn btn-success"><strong><em> table matiere</em></strong></h5>
    <li class="nav-item">
